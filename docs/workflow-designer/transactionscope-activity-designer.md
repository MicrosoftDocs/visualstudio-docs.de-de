...
|<xref:System.Activities.Statements.TransactionScope.AbortInstanceOnTransactionFailure*>|Wahr|Gibt den Wert an, der angibt, ob der Workflow abgebrochen werden soll, wenn die Transaktion abbricht.|
