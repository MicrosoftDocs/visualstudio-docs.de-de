...
description: Lernen Sie, Klassen-Designfehler zu beheben, indem Sie den geänderten oder verschobenen Quellcode erneut in das Klassendiagramm ziehen, um ihn anzuzeigen.
