...
| MSBuild verwendet automatisch Assemblys und Windows-Metadatendateien (*. winmd*). | J | Verweise im SDK werden automatisch an den Compiler übergeben. | J | |
...
| Sie können einer großen vorhandenen Community von Paketerstellern beitreten. | – | Die Community ist neu. | J | |
| Sie können einer großen vorhandenen Community von Paketverbrauchern beitreten. | – | Die Community ist neu. | J | |
| Sie können an einem Ökosystem von Partnern (benutzerdefinierte Galerien, Repositorys usw.) teilhaben. | – | Die verfügbaren Repositorys umfassen Visual Studio Marketplace, Microsoft Download Center und [!INCLUDE[win8_appstore_long](../debugger/includes/win8_appstore_long_md.md)]. | J | |
...
| Sie können ein Symbolpaket für die Debugunterstützung verwenden. | J | Wenn Sie *PDB* -Dateien im SDK ablegen, werden die Dateien automatisch abgerufen. | J | |
| Der Mechanismus unterstützt automatische Paketmanagerupdates. | – | Das SDK wird mit MSBuild überarbeitet. | J | |
