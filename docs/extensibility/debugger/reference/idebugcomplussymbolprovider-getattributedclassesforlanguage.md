---
description: Ruft die Klassen mit dem angegebenen Attribut ab, das in der angegebenen Programmiersprache implementiert ist.
...
`ppEnum`\
vorgenommen Gibt eine Enumeration der Attribut Klassen zurück.
