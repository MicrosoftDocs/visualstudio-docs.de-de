---
description: Erstellt einen Zeiger auf den angegebenen Typ.
...
`pPtrToTypeField`\
vorgenommen Gibt den Zeiger zurück, der durch ein neues **idebugfield** -Objekt dargestellt wird.
