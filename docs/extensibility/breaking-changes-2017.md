...
* Zuvor hat Visual Studio viele Registrierungsschlüssel im System **HKEY_LOCAL_MACHINE** und **HKEY_CURRENT_USER** Strukturen unter einem Visual Studio-spezifischen Schlüssel installiert:
