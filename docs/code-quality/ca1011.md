...
description: Eine Methoden Deklaration enthält einen formalen Parameter, der ein abgeleiteter Typ ist, und die Methode ruft nur Member des Basistyps des Parameters auf.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
