...
description: Ein Typ, der speziell für Component Object Model (com) als sichtbar gekennzeichnet ist, enthält eine öffentliche statische Methode.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1407
