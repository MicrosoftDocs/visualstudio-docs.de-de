...
ms.date: 11/04/2016
description: Erfahren Sie mehr über den Regelsatz mit den grundlegenden Regeln für Richtigkeit in Visual Studio, der sich auf logische Fehler und allgemeine Framework-API-Fehler bezieht. Siehe Regel Beschreibungen.
