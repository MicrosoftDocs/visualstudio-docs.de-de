...
description: Ein Werttyp, der speziell für Component Object Model (com) als sichtbar gekennzeichnet ist, deklariert ein nicht öffentliches Instanzfeld.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1413
