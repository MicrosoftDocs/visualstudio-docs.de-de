---
description: Die folgenden veralteten FxCop-Analyse Regeln sind veraltet und werden nicht als Analyzers implementiert.
title: Veraltete Regeln
ms.date: 05/21/2019
ms.topic: reference
helpviewer_keywords:
- fxcop rules
