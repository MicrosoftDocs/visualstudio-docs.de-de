...
description: Eine transparente Methode ist mit dem System. Runtime. ExceptionServices. processprocesscorruptedstateexceptionsattribute-Attribut gekennzeichnet.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2139
