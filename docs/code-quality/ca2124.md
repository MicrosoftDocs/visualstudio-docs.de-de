...
description: In den Versionen 1,0 und 1,1 des .NET Framework enthält eine öffentliche oder geschützte Methode einen try/catch/after-Block. Der schließlich-Block scheint den Sicherheitszustand zurückzusetzen und ist nicht in einem schließlich-Block eingeschlossen.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2124
