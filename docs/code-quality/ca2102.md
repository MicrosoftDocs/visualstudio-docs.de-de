...
description: Ein Member in einer Assembly, der nicht mit dem System. Runtime. CompilerServices. RuntimeCompatibilityAttribute markiert ist oder als RuntimeCompatibility (wrapnonexceptionlöst = false) gekennzeichnet ist, enthält einen catch-Block, der System. Exception behandelt und keinen unmittelbar folgenden allgemeinen catch-Block enthält.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2102
...
[CA1031: Allgemeine Ausnahmetypen nicht auffangen.](/dotnet/fundamentals/code-analysis/quality-rules/ca1031)
