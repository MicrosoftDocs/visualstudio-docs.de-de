...
description: Eine transparente Methode erfordert eine <xref:System.Security.Permissions.SecurityAction> oder eine andere Sicherheitsanforderung.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2142
