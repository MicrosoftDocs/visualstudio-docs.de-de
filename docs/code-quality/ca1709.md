...
description: Der Name eines Bezeichners ist nicht ordnungsgemäß geschrieben, enthält einen aus zwei Buchstaben bestehenden Akronym und den zweiten Buchstaben in Kleinbuchstaben oder enthält ein Akronym mit drei oder mehr Großbuchstaben.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
