...
description: Eine öffentliche oder geschützte Methode wird mit dem DllImport-Attribut gekennzeichnet. Entweder konnte die nicht verwaltete Bibliothek nicht gefunden werden, oder die Methode konnte keiner Funktion in der Bibliothek zugeordnet werden.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1400
