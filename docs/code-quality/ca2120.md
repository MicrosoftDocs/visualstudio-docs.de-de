...
description: Der Typ implementiert die System. Runtime. Serialization. iserialisierbare Schnittstelle, ist kein Delegat oder eine Schnittstelle und wird in einer Assembly deklariert, die teilweise vertrauenswürdige Aufrufer zulässt.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2120
