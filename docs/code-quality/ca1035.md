...
description: Ein öffentlicher oder geschützter Typ implementiert System. Collections. ICollection, stellt jedoch keine stark typisierte Methode für CopyTo bereit.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
