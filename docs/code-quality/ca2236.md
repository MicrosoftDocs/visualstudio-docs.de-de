...
description: Ein Typ wird von einem Typ abgeleitet, der iserialisierbar implementiert, und entweder implementiert der Typ den Serialisierungskonstruktor, ruft jedoch nicht den Serialisierungskonstruktor des Basistyps auf. oder der Typ implementiert GetObjectData, ruft jedoch nicht die GetObjectData-Methode des Basistyps auf.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2236
