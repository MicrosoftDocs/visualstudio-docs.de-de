...
description: Eine Klasse oder ein Klassenmember verwendet <xref:System.Security.Permissions.SecurityAction> in einer Anwendung, die Sicherheit auf Ebene 2 verwendet.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2135
