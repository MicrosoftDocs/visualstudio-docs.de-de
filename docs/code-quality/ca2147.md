...
description: Code, der als System. Security. SecurityTransparentAttribute markiert ist, verfügt nicht über ausreichende Berechtigungen für Assert.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
[Sicherheitswarnungen](/dotnet/fundamentals/code-analysis/quality-rules/security-warnings)
