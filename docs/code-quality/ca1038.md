...
description: Ein öffentlicher oder geschützter Typ implementiert System. Collections. IEnumerator, stellt jedoch keine stark typisierte Version der aktuellen Eigenschaft bereit.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
