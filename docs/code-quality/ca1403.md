...
description: Ein COM-sichtbarer Werttyp ist mit dem System. Runtime. InteropServices. StructLayoutAttribute-Attribut gekennzeichnet, das auf LayoutKind. Auto festgelegt ist.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
