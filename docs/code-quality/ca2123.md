...
description: Eine öffentliche oder geschützte Methode in einem öffentlichen Typ überschreibt eine Methode oder implementiert eine Schnittstelle und hat nicht denselben LinkDemand wie die Schnittstelle oder virtuelle Methode.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2123
