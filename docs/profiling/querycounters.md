...
description: Hier erfahren Sie mehr über die Option QueryCounters, mit der die auf dem Computer verfügbaren CPU-(Hardware-)Leistungsindikatoren aufgelistet werden.
ms.date: 11/04/2016
ms.topic: conceptual
