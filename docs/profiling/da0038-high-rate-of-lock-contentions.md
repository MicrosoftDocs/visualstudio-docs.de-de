...
description: Die zusammen mit den Profilerstellungsdaten erfassten Systemleistungsdaten deuten darauf hin, dass während der Anwendungsausführung ein überaus hohes Maß an Sperrkonflikten aufgetreten ist.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- vs.performance.38
