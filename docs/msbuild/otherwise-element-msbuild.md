...
description: Erfahren Sie, wie MSBuild mithilfe des Otherwise-Elements den Codeblock angibt, der (ausschließlich dann) ausgeführt wird, wenn die Bedingungen aller When-Elemente als FALSE ausgewertet werden.
