...
### <a name="roslyn-diagnostics-and-quick-fixes-for-unity"></a>Roslyn-Diagnose und Schnellkorrekturen für Unity
...
![Zeichenfolgenvergleich beim VS-Refactoring mit CompareTag](media/unity-diagnostics.png)
