...
description: Erfahren Sie, wie Sie mit dem Modell-Editor in Visual Studio 3D-Modelle erstellen, die in DirectX-basierten Spielen oder Apps eingesetzt werden können.
