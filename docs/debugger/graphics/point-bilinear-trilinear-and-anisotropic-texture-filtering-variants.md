...
description: Wenn die Leistungskosten für eine Punkt-, bilineare, trilineare oder anisotrope Texturfiltervariante sehr wichtig sind, können Sie überprüfen, ob ihre Verwendung diese Kosten wert ist.
