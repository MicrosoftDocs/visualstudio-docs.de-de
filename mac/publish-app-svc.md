...
description: In diesem Artikel erfahren Sie, wie Sie eine Webanwendung mithilfe der Veröffentlichungstools in Visual Studio für Mac veröffentlichen.
ms.date: 04/02/2019
helpviewer_keywords:
- deployment, website
...
- Ein ASP.NET Core-Projekt. Wenn Sie noch kein Projekt haben, können Sie [ein neues Projekt erstellen](~/create-new-projects.md).
