...
> [!IMPORTANT]
> Die bereitgestellten Supportincidents dienen zur Problemlösung.  Sie dürfen nicht zur Unterstützung bei Fehlern in der Programmierung oder Entwicklung für folgende Produkte verwendet werden:
> - Microsoft Teams
> - Microsoft Office
...
1. Wechseln Sie zu <https://my.visualstudio.com/Benefits>, scrollen Sie nach unten zum Abschnitt „Support“, und klicken Sie auf der Kachel „Technischer Support“ auf **Chat to activate** (Chat für die Aktivierung).
    ...
    > ![Kachel des Vorteils „Technischer Support“](_img/vs-tech-support/vs-tech-support-tile.png "Klicken auf „Chat to activate“ (Zum Aktivieren chatten) in der Kachel des technischen Supports")
...
3. Sie müssen dem Mitarbeiter Folgendes angeben, um den Vorgang abzuschließen:
   ...
   > [!div class="mx-imgBorder"]
   > ![Vorteil „Technischer Support“: Finden der Abonnement-ID](_img/vs-tech-support/vs-tech-support-subID-cropped.png "Suchen der Abonnement-ID auf der Registerkarte „Abonnements“")
...
Nachdem Sie Ihre **Vertrags-ID** und **Zugriffs-ID** eingerichtet haben, können Sie dem technischen Support damit Incidents melden. 

Sie können Incidents online, telefonisch oder über das Azure-Portal übermitteln. 

### <a name="submit-an-incident-online"></a>Übermitteln eines Incidents (online)
Führen Sie die folgenden Schritte aus, um einen Incident an den Support für das Unternehmensportal zu übermitteln:

  > [!NOTE]
  > Möglicherweise erhalten Sie die Benachrichtigung, dass Sie Ihre E-Mail-Adresse bestätigen müssen.  Klicken Sie im Hinweis auf den Link **E-Mail senden**, um die Bestätigungs-E-Mail an die in Ihrem Profil aufgeführte E-Mail-Adresse zu senden. 

1. Melden Sie sich bei <https://support.microsoft.com/en-us/supportforbusiness/productselection> an.

0. Wählen Sie im Abschnitt **Schritt 1** die entsprechenden Einträge aus den Dropdownlisten aus, um Ihr Produkt, Ihre Version, das Problem usw. anzugeben. Vervollständigen Sie die Textfelder für die Zusammenfassung und die ausführliche Beschreibung des Problems. Klicken Sie dann auf **Weiter**.
   > [!div class="mx-imgBorder"]
   > ![Erstellen einer neuen Supportanfrage](_img/vs-tech-support/vs-tech-support-create-new.png "Ausfüllen der Felder zum Erstellen einer neuen Supportanfrage") 
0. Geben Sie im Abschnitt **Schritt 2** Ihren Standort und Ihre Zeitzone an.
0. Klicken Sie auf **Vertrag hinzufügen**.
0. Geben Sie die **Zugriffs-ID** und die **Vertrags-ID** an, die Sie in der Bestätigungs-E-Mail erhalten haben, als Sie Ihren Supportvorteil aktiviert haben. Klicken Sie auf **Hinzufügen**.
   > [!div class="mx-imgBorder"]
   > ![Vertrags-ID hinzufügen](_img/vs-tech-support/vs-tech-support-add-contract-id.png "Hinzufügen der Zugriffs-ID und der Vertrags-ID aus der Bestätigungs-E-Mail") 
0. Ihr neuer Supportvertrag wird in **Schritt 2** angezeigt.  Wählen Sie ihn aus.
0. Geben Sie den Schweregrad Ihres Problems an.  Die Standardeinstellung ist „Wichtig“. 
0. Wählen Sie aus, wann Sie Support erhalten möchten. Die Standardeinstellung lautet „Only during business hours“ (Nur während der Geschäftszeiten). Die Option für Rund-um-die-Uhr-Support ist nur verfügbar, wenn Sie „Kritisch“ als Schweregrad auswählen.
0. Klicken Sie zum Fortfahren auf **Weiter** . 
0. Geben Sie für **Schritt 3** die Kontaktinformationen an, über die Ihr Supportansprechpartner Sie kontaktieren soll. 
   > [!div class="mx-imgBorder"]
   > ![Bestätigen Ihrer Kontaktinformationen](_img/vs-tech-support/vs-tech-support-contact-info.png "Überprüfen Ihrer Kontaktinformationen und der bevorzugten Kontaktmethode") 
0. In **Schritt 4** haben Sie die Möglichkeit, diese Supportanfrage für andere Personen in Ihrem Team freizugeben.  Geben Sie die E-Mail-Adressen der Personen ein, für die Sie die Anforderung freigeben möchten. Klicken Sie auf **Weiter**, um zum nächsten Schritt zu wechseln.
0. In **Schritt 5** werden alle Informationen zusammengefasst, die Sie für den Incident bereitgestellt haben.  Wenn alle Angaben korrekt sind und Sie den Vorgang fortsetzen möchten, klicken Sie auf **Einreichen**. 
 
### <a name="submit-an-incident-by-phone"></a>Übermitteln eines Incidents (per Telefon)
Wenn Sie eine Supportanfrage per Telefon einreichen möchten, suchen Sie die Telefonnummer des [Kundendiensts](https://support.microsoft.com/help/13948/global-customer-service-phone-numbers) für Ihr Land/Ihre Region. Achten Sie darauif, dass Ihnen beim Anruf Ihre Vertrags-ID und Ihre Zugriffs-ID vorliegt.

### <a name="submit-an-incident-in-the-azure-portal"></a>Übermitteln eines Incidents im Azure-Portal
...
0. Klicken Sie in der linken Navigationsleiste auf **Hilfe und Support**.
0. Klicken Sie unter „Support“ auf **Neue Supportanfrage**.
