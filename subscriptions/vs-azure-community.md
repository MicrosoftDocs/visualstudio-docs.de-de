...
:::row:::
    :::column:::
        ...
        - [Azure-Verwaltungsportal](https://social.msdn.microsoft.com/Forums/home?forum=windowsazuremanagement&filter=alltypes&sort=lastpostdesc)  
    :::column-end:::
    :::column:::
        ...
        - [Azure-Netzwerk (DNS, Traffic Manager, VPN, VNET)](https://social.msdn.microsoft.com/Forums/home?forum=WAVirtualMachinesVirtualNetwork&filter=alltypes&sort=lastpostdesc)  
        - [Azure-Skripterstellungs- und -Befehlszeilentools](https://social.msdn.microsoft.com/forums/home?forum=azurescripting&filter=alltypes&sort=lastpostdesc)  
    ...
    :::column-end:::
    :::column:::
        - [Azure SQL-Datenbank](https://social.msdn.microsoft.com/Forums/home?forum=ssdsgetstarted&filter=alltypes&sort=lastpostdesc)  
        - [Azure Stack](https://social.msdn.microsoft.com/forums/home?forum=AzureStack&filter=alltypes&sort=lastpostdesc)  
        - [Azure Storage (in englischer Sprache)](https://social.msdn.microsoft.com/Forums/home?forum=windowsazuredata&filter=alltypes&sort=lastpostdesc)  
        - [Dokumentation zu virtuellen Computern](https://social.msdn.microsoft.com/Forums/home?forum=WAVirtualMachinesforWindows&filter=alltypes&sort=lastpostdesc)  
        ...
        - [Cloud Services (Web- und Workerrollen)](https://social.msdn.microsoft.com/Forums/home?forum=windowsazuredevelopment&filter=alltypes&sort=lastpostdesc)  
        - [Preise und Abrechnung](https://social.msdn.microsoft.com/Forums/azure/home?forum=windowsazurepurchasing&filter=alltypes&sort=lastpostdesc)  
    :::column-end:::
:::row-end:::
...
3. Sie sehen eine Liste der verfügbaren Foren.  Klicken Sie einfach auf ein Forum Ihrer Wahl.
    > [!div class="mx-imgBorder"]
    > ![Azure-Communityforen](_img/vs-azure-community/vs-azure-community-forums.png "Wählen Sie auf der Supportseite der Azure-Community die gewünschten Foren aus.")
...
4. Innerhalb eines Forums können Sie Themen und Antworten anzeigen, nach Antworten auf Ihre Frage suchen oder eine neue Frage stellen.
    > [!div class="mx-imgBorder"]
    > ![Azure-Community – Beispiel](_img/vs-azure-community/vs-azure-community-example.png "In den Foren können Sie nach Themen und Antworten suchen oder neue Fragen veröffentlichen.")
...
- Benötigen Sie Unterstützung bei Vertrieb, Abonnements, Konten und Abrechnung für Visual Studio-Abonnements?  Wenden Sie sich an den [Abonnementsupport](https://aka.ms/vssubscriberhelp) für Visual Studio.
